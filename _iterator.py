...
class Iterator:
    def __init__(self, path_to_file: str, class_name: str) -> None:
        ...
        Raises:
            ...
            if there is no csv file with this path
    ...
    def __next__(self) -> str:
        """The function of switching to the next instance of the list 
        in the class object

        Raises:
            StopIteration: If the counter reaches the border of the list,
            it throws an exception and stops the iterator
