...
def solve(a, b, c):
    """Решает квадратное уравнение и выводит корни на экран."""
...
def solve_cubic(a, b, c, d):
    """Решает кубическое уравнение и выводит корни на экран."""
    # проверяем, что a не равно нулю
    if a == 0:
...
def plot_quadratic(a, b, c):
    """Рисует график квадратного уравнения и показывает его на экране."""
...
def plot_cubic(a, b, c, d):
    """Рисует график кубического уравнения и показывает его на экране."""
    # импортируем модули numpy и matplotlib
    import numpy as np
    import matplotlib.pyplot as plt
    # создаем массив значений x в диапазоне от -10 до 10 с шагом 0.1
...
def to_binary(number):
    """Возвращает двоичное представление целого неотрицательного числа."""
...
def to_fraction(decimal):
    """Возвращает обычную дробь, эквивалентную десятичной."""
...
menu = ["сложение", "вычитание", "умножение", "деление", "остаток", 
        "степень", "корень", "логарифм", "синус", "косинус", 
        "тангенс", "арксинус", "арккосинус", "арктангенс", 
        "экспонента", "факториал", "НОД", "НОК", 
        "радианы", "градусы"]

# создаем функцию для вывода меню и ввода выбора пользователя
def choose():
    """Выводит меню и возвращает название выбранной пользователем функции."""
    # выводим приветствие
...
def calculate(function):
    """Вводит аргументы и вычисляет результат с помощью выбранной функции."""
    # вводим аргументы в зависимости от количества параметров функции
    if function in ["сложение", "вычитание", "умножение", 
                    "деление", "остаток", 
                    "степень", "логарифм", 
                    "НОД", "НОК"]:
