...
if __name__ == '__main__':
    ...
    a.add_argument('-i','--init_path',default='files\\settings.json',help='Путь к json файлу с данными, default = files\\settings.json', action='store') 
    ...
    mode = (A.find, A.check, A.statistic)
